...
% INIT_JPEG Initialize quantization table and zig-zag scan for JPEG-like image
% coding.
%    [QT, ZAG] = INIT_JPEG(QUALITY) Returns the a row vector QT which is the
%    quantization step sizes for the DCT coefficients of an 8x8 block in the
%    order determined by the zig zag pattern for JPEG encoding. The elements
%    of QT are scaled by QUALITY which should be in the range 1 to 100
%    
